...
if isfile(MatlabUidPath)&&System.IO.Path.GetFullPath(System.Environment.ExpandEnvironmentVariables(MatlabUidPath))~=which('Gbec.UID')
	Gbec.Exception.Generated_UID_not_on_path.Warn;
end
