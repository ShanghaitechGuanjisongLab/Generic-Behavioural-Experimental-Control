...
using AssociationTrial=Trial<UID::Trial_LightWater, Sequential<CalmDown, DynamicSlot<>::template Load<SerialMessage<UID::Event_MonitorMiss>>, ResponseWindow, PinFlashUpDown<BlueLed, 200, UID::Event_LightUp, UID::Event_LightDown>, DelayMilliseconds<800>, ModuleAbort<ResponseWindow>, DynamicSlot<>, PinFlashUp<WaterPump, 10, UID::Event_Water>, DelaySeconds<20>>>;

using AudioWater = Trial<UID::Trial_AudioWater, Sequential<DelayMilliseconds<800>, DelaySeconds<20>>>;

using ResponseWindow = MonitorPin<CapacitorOut, Sequential<SerialMessage<UID::Event_MonitorHit>, DynamicSlot<>::Clear>>;

using LightWater = Trial<UID::Trial_LightWater, Sequential<CalmDown, DynamicSlot<>::template Load<SerialMessage<UID::Event_MonitorMiss>>, ResponseWindow, PinFlashUpDown<BlueLed, 200, UID::Event_LightUp, UID::Event_LightDown>, DelayMilliseconds<800>, ModuleAbort<ResponseWindow>, DynamicSlot<>, PinFlashUp<WaterPump, 10, UID::Event_Water>, DelaySeconds<20>>>;
