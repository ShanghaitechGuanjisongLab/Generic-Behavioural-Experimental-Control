...
%%
%[text] 检查水管-多次水量检查
Test1.RepeatCheck(Gbec.UID.Test_WaterPump); %[output:2ca65dc3]
%%
%[text] 检查水管-单次水量检查
Test1.OneEnterOneCheck(Gbec.UID.Test_WaterPump,"按一次回车喷一次水，输入任意字符结束检查：");
%%
%[text] 电容重置
Test1.RepeatCheck(Gbec.UID.Test_CapacitorReset,1); %[output:33aa8e70]
%%
%[text] 开始检查电容
Test1.StartCheck(Gbec.UID.Test_CapacitorMonitor); %[output:74f72178]
%%
%[text] 停止检查电容
...
%%
%[text] 检查低音
Test1.OneEnterOneCheck(Gbec.UID.Test_LowTone,"按一次回车一个低音，输入任意字符结束检查："); %[output:1b367dda] %[output:9a0cda39]
%%
%[text] 检查高音
