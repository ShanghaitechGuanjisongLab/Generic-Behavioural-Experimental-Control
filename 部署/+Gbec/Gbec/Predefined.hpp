...
template <typename Period, typename Content, typename Unit, DurationRep Value>
...
template <typename Unit, DurationRep Period, typename Content, typename Duration>
struct _RepeatEvery_Constant_UntilDuration : RepeatEvery<ConstantDuration<Unit, Period>, Content>
{
	...
	void WriteInfo(std::ostringstream &InfoStream) const override
	{
		InfoWrite(InfoStream, static_cast<uint8_t>(4), UID::Field_ID, UID::Type_UID, ModuleID<_RepeatEvery_Random_UntilDuration>::ID, UID::Field_Content, UID::Type_Pointer, &ModuleID<Content>::ID, UID::Field_Period, _TypeID<Unit>::value, Period, UID::Field_Duration, UID::Type_Pointer, &Duration::ID);
	}
...
template <typename Unit, DurationRep Period, typename Content>
...
template <typename Unit, DurationRep Period, typename Content, DurationRep Duration>
struct _RepeatEvery_Constant_UntilDuration<Unit, Period, Content, ConstantDuration<Unit, Duration>> : RepeatEvery<ConstantDuration<Unit, Period>, Content>
{
	...
	void WriteInfo(std::ostringstream &InfoStream) const override
	{
		InfoWrite(InfoStream, static_cast<uint8_t>(4), UID::Field_ID, UID::Type_UID, ModuleID<_RepeatEvery_Random_UntilDuration>::ID, UID::Field_Content, UID::Type_Pointer, &ModuleID<Content>::ID, UID::Field_Period, _TypeID<Unit>::value, Period, UID::Field_Duration, _TypeID<Unit>::value, Duration);
	}
...
template <typename PeriodA, typename ContentA, typename PeriodB, typename ContentB, typename Unit, DurationRep Duration>
...
template <typename Unit, DurationRep PeriodA, typename ContentA, DurationRep PeriodB, typename ContentB, typename Duration>
struct _DoubleRepeat_Constant_UntilDuration : DoubleRepeat<ConstantDuration<Unit, PeriodA>, ContentA, ConstantDuration<Unit, PeriodB>, ContentB>
{
	...
	void WriteInfo(std::ostringstream &InfoStream) const override
	{
		InfoWrite(InfoStream, static_cast<uint8_t>(6), UID::Field_ID, UID::Type_UID, ModuleID<_DoubleRepeat_Random_UntilDuration>::ID, UID::Field_ContentA, UID::Type_Pointer, &ModuleID<ContentA>::ID, UID::Field_PeriodA, _TypeID<Unit>::value, PeriodA, UID::Field_ContentB, UID::Type_Pointer, &ModuleID<ContentB>::ID, UID::Field_PeriodB, _TypeID<Unit>::value, PeriodB, UID::Field_Duration, UID::Type_Pointer, &Duration::ID);
	}
...
template <typename Unit, DurationRep PeriodA, typename ContentA, DurationRep PeriodB, typename ContentB>
...
public:
	...
	void WriteInfo(std::ostringstream &InfoStream) const override
	{
		InfoWrite(InfoStream, static_cast<uint8_t>(6), UID::Field_ID, UID::Type_UID, ModuleID<_DoubleRepeat_Random_UntilDuration>::ID, UID::Field_ContentA, UID::Type_Pointer, &ModuleID<ContentA>::ID, UID::Field_PeriodA, _TypeID<Unit>::value, PeriodA, UID::Field_ContentB, UID::Type_Pointer, &ModuleID<ContentB>::ID, UID::Field_PeriodB, _TypeID<Unit>::value, PeriodB, UID::Field_Duration, _TypeID<Unit>::value, Duration);
	}
...
struct _IDModule;
template <UID ID>
using IDModule = typename _IDModule<ID>::type;
...
#define AssignModuleID(Module, ID)       \
	template <>                          \
	struct ModuleID<Module>              \
	{                                    \
		static UID const ID;             \
	};                                   \
	template <>                          \
	UID const ModuleID<Module>::ID = ID; \
	template <>                          \
	struct _IDModule<ID>                  \
	{                                    \
		using type = Module;             \
